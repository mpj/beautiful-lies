...
// license: MIT
(function() {
  var args_as_array, arrays_equal, callback_arguments_array, create_liar, filter_on_args, filter_on_function, find_function, generateHandler, injectLies, injectPlugins, inject_and_return, is_function, lie, remove_functions, run_callback, run_callbacks, run_delayed,
    __slice = [].slice;
  ...
  generateHandler = function(function_name, lies) {
    var handler;
    handler = function() {
      var lies_matching_args, lies_matching_function, message, _i, _len;
  ...
  run_callbacks = function(lie, arguments_obj) {
    var callback, callback_chain, m, y, _i, _len, _ref;
    callback = find_function(arguments_obj);
    callback_chain = lie.run_callback;
    if (callback_chain) {
      if (!Array.isArray(callback_chain)) {
    ...
    if (lie.run_function) {
      return lie.run_function.bind(lie.host)();
    }
  };
