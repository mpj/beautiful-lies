...
// license: MIT
(function() {
  var args_as_array, arrays_equal, assignHandler, filter_on_args, filter_on_function, find_function, handle_function_call, injectMacros, is_function, lie, macros, preprocessExpectation, remove_functions, run_delayed,
  ...
  preprocessExpectation = function(expectation) {
    ...
    return injectMacros(expectation);
  };
    ...
    handler = function() {
      ...
      process_single_callback_spec = function(callback_spec) {
        ...
        if (assignPropertyWithName) {
          fn = function(propValue) {
            return host[assignPropertyWithName] = propValue;
          };
